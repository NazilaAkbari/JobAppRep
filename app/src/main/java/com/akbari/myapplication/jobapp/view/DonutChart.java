package com.akbari.myapplication.jobapp.view;
...
public class DonutChart extends View {
    ...
    public DonutChart(Context context, AttributeSet attrs) {
        ...
        try {
            radius = a.getDimension(R.styleable.DonutChart_radius, 10.0f);
        } finally {
            a.recycle();
        }
        paint = new Paint();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setShadowLayer(8, adjust, -adjust, 0xaa97b93d);
        drawDonut(canvas, paint, 0, 359.9f);
        setGradient(0xff4AB6C1, 0xff2182AD);
        drawDonut(canvas, paint, 0, hour);
